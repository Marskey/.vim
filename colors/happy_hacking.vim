...
call s:Color("Cursor",   s:black1, s:white,  s:t_black1, s:t_white)
...
call s:Color("Visual",   "NONE",   s:gray2,  "NONE",     s:t_gray2)
...
call s:Color("CursorLine",   "NONE",  s:gray6, "NONE",    s:t_gray6)
...
call s:Color("SpecialKey", s:gray2, "NONE", s:t_gray1, "NONE")
